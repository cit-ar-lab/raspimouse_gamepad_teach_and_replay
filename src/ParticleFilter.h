...
//	Action sensorUpdate(Observation *obs, Episodes *ep, raspimouse_gamepad_training_replay::PFoEOutput *out);
	Action sensorUpdate(Observation *obs, Action *act, Episodes *ep, raspimouse_gamepad_training_replay::PFoEOutput *out);
